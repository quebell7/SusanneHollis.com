				...
				<div class="panel-body">
					...
					<div class="row">	
						...
						<div class="col-md-3">
							...
							<div class="form-group">
								<label for="jq_issueSingleCertInstructor">Instructor</label>										
								<select id="jq_issueSingleCertInstructor" class="form-control" name="instructorID">
									<option value="">- Select -</option>
									<?php
...
-->
						...
						<div class="col-md-2">
							<div class="form-group">
								<label>&nbsp;</label>
								<button type="submit" id="jq_issueSingleCertificate" class="btn btn-primary btn-md btn-block" whichone="process" >Process Certification</button>
	...
	<div class="row">
		<div class="col-sm-4 col-sm-offset-4">
			<button type="submit" id="jq_saveChanges" class="btn btn-default btn-block" whichone="save" value="<?php echo $submitType ?>"><?php echo $submitDisplay ?></button>
		</div>
	</div>
