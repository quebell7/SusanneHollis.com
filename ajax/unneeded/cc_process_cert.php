<?php
	...
	if(!isset($_REQUEST['cert101Number']) || $_REQUEST['cert101Number'] ==''){
		exit;
	}
	
	$description 			= '101 Cert Purchase';
	$perItemPrice			= $cert101PerItemPrice;
	
	$numberOfValidations 	= $_REQUEST['cert101Number'];
...
*/
	...
	if($aimResponceCode == 1){
		$returnToUser	.= "<br/>$numberOfValidations 101 Cert's totaling $$aimResponceAmount.";
	}
	...
	if($aimResponceCode == 1){
		...
		$add = $fmpConnection->newAddCommand('web_certFees');
